			...
			<div class="navbar navbar-default navbar-fixed-bottom"
				...
				<div class="container">
					<div class="navbar-text pull-left">
						<p>@2016 All Rights given to choco</p>
					</div>
					...
					<a href="http://www.facebook.com"><i
						class="fa fa-facebook fa-2x"></i></a>&nbsp &nbsp<a href="http://www.twitter.com"><i
						class="fa fa-twitter fa-2x"></i></a> &nbsp &nbsp<a href="http://www.google.com"><i
						class="fa fa-google fa-2x"></i></a>
				</div>
			</div>
		</div>
	</div>
